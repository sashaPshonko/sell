...
export const SELL_DEFAULTS = {
    ...
    REPUBLISH_WHEN: 'paid',
    PUBLISH_DELAY_MS: '120000',
    PUBLISH_RETRY_MS: '120000',
    PUBLISH_MAX_RETRIES: '30',
    ...
    CREATE_ITEM_MUTATION_FILE: './captures/create-item.graphql',
    UPDATE_ITEM_MUTATION_FILE: './captures/update-item.graphql',
};
